...
<div id="app">
    <div class="content">
        <div class="head">
            ...
            <h1 class="themosis">Themosis - Archive</h1>
            <p class="baseline">Para empezar presione en <a href="{{url('listado')}}">listado</a></p>
        </div>
        <ul class="links">            
            <li><a href="{{url('listado')}}" title="Listado">Listado</a></li>
        </ul>
    </div>
</div>
<?php wp_footer(); ?>
